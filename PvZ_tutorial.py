...
click = True
wind_help = canvas.create_rectangle((shift_x1 + w // 100, shift_y - h // 100), (w - shift_x1 - w // 100, h - shift_y + h // 100), fill="#D2B48C", outline="#8B4513")
...
"2.1 Растения не бесплатные. Чтобы купить растение, необходимо чтобы тебе хватало солнц.", "Кол-во твоих солнц показано скраю экрана, цена растения - на кнопке с ним.",
"3. Принципы работы растений (сверху вниз):", "Подсолнух - даёт солнца по клику по нему. Чем больше подсолнухов, тем больше солнц за клик.",
       ...
       "Стена-орех - пушечное мясо.", "4. Для победы необходимо убить определённое количество (см рядом с солнцами) зомби, они появляются как поставишь несколько растений.",
       "Удачи!"]
txt_print = list()
